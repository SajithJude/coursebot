...
try:
    if toc:
        toc_res = index.query(f"Generate a table of contents for this document with topics and subtopics in JSON format, exclude the topics named Objective ,Keywords,and Check Your Progress")
        str_toc = str(toc_res)
