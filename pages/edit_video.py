...
def update_app():
    ...
    with col1:
        prev_button = st.button("Previous", on_click=previous_button_callback, key=f"prev{st.session_state.current_scene_index}")
    ...
    with col3:
        next_button = st.button("Next", on_click=next_button_callback, key=f"nex{st.session_state.current_scene_index}")
