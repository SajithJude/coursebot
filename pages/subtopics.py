...
if button:
    res = st.session_state.index.query("Generate a table of contents for this document excluding objective, and include only topics and subtopics in its hierarchy ")
